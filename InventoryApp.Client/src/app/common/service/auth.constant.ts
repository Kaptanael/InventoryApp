...
export const accessTokenBody = `grant_type=password&username={0}&password={1}&scope=inventory.fullaccess&client_id=recruitmentweb&client_secret=${encodeURIComponent(clientSecret)}`;
